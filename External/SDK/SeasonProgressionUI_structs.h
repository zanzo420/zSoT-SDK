...
struct FSeasonIconPopupAsset
{
	...
	unsigned char                                      UnknownData_J0KW[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonGoalPopupAsset
{
	...
	unsigned char                                      UnknownData_37VD[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUIEventTypeTelemetryFragment
{
	...
	unsigned char                                      UnknownData_VLGX[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUITelemetryFragment
{
	...
	unsigned char                                      UnknownData_H98C[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FNavigationDesc
{
	...
	unsigned char                                      UnknownData_EGUF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEnableMoreButtonEvent
{
	...
	unsigned char                                      UnknownData_9DNS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSeasonNotificationContent
{
	...
	unsigned char                                      UnknownData_1A0O[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FDeedProgressDesc
{
	...
	unsigned char                                      UnknownData_CAJH[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOpenSeasonsMenuEvent
{
	...
	unsigned char                                      UnknownData_9H78[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       Id;                                                        // 0x0004(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct FSeasonsPopupEvent
{
	...
	unsigned char                                      UnknownData_S1HZ[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
