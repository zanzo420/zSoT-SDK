...
{
	static auto fn = UObject::FindObject<UFunction>("Function bsp_beach_rocks_08.bsp_beach_rocks_08_C.UserConstructionScript");
...
void Absp_beach_rocks_08_C::AfterRead()
{
	ABP_Placement_HeightDrop_C::AfterRead();

	READ_PTR_FULL(bsp_rock_small_01_e, UStaticMeshComponent);
	READ_PTR_FULL(bsp_rock_medium_01_c, UStaticMeshComponent);
...
void Absp_beach_rocks_08_C::BeforeDelete()
{
	ABP_Placement_HeightDrop_C::BeforeDelete();

	DELE_PTR_FULL(bsp_rock_small_01_e);
	DELE_PTR_FULL(bsp_rock_medium_01_c);
