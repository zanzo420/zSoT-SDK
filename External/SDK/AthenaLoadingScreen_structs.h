...
{
	unsigned char                                      UnknownData_JLTA[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QCLS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JB0P[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
