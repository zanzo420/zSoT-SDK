...
{
public:
	unsigned char                                      UnknownData_WY2R[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5SOH[0x7F];                                    // 0x0449(0x007F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_V3LO[0xC];                                     // 0x03EC(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KV5E[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
