...
{
	unsigned char                                      UnknownData_7K45[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RHX9[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FSessionServiceLog
{
	...
	unsigned char                                      UnknownData_0UOI[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FSessionServicePong
{
	...
	unsigned char                                      UnknownData_5SJA[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PKFC[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_INZR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
