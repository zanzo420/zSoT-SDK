...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass hulllivery_sunkenkingdom_hull_01_CustomizationDesc.hulllivery_sunkenkingdom_hull_01_CustomizationDesc_C");
		return ptr;
	}
