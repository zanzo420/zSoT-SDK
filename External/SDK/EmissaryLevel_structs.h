...
struct FLightVisualisation
{
	...
	unsigned char                                      UnknownData_NRXJ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissaryLevelData
{
	...
	unsigned char                                      UnknownData_CLZG[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8YN6[0x4];                                     // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FEmissaryEventAward
{
	...
	unsigned char                                      UnknownData_71Y3[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissaryGameEventsReward
{
	...
	unsigned char                                      UnknownData_JOPR[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FEmissaryCompanyActionReward
{
	...
	unsigned char                                      UnknownData_LHSH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissaryKillPlayerReward
{
	...
	unsigned char                                      UnknownData_JULT[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6PCB[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZSPF[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FUpdateEmissaryValueForCompany
{
	...
	unsigned char                                      UnknownData_JCQ0[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDeactivateEmissaryForCrew
{
	...
	unsigned char                                      UnknownData_QZ9G[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_STQO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LGR3[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEmissaryRoleplayActionTelemetryEvent
{
	...
	unsigned char                                      UnknownData_IGO1[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissarySessionEndTelemetryEvent
{
	...
	unsigned char                                      UnknownData_2C77[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GYGX[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_I844[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
