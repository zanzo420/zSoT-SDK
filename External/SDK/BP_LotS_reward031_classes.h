...
// BlueprintGeneratedClass BP_LotS_reward031.BP_LotS_reward031_C
// 0x0018 (FullSize[0x04B0] - InheritedSize[0x0498])
class ABP_LotS_reward031_C : public AModalInteractionProxy
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_LotS_reward031.BP_LotS_reward031_C");
		return ptr;
	}
