...
{
	static auto fn = UObject::FindObject<UFunction>("Function bsp_plm_cluster_02_b.bsp_plm_cluster_02_b_C.UserConstructionScript");
...
void Absp_plm_cluster_02_b_C::AfterRead()
{
...
void Absp_plm_cluster_02_b_C::BeforeDelete()
{
