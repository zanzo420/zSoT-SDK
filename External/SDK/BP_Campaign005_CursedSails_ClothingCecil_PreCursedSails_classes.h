...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign005_CursedSails_ClothingCecil_PreCursedSails.BP_Campaign005_CursedSails_ClothingCecil_PreCursedSails_C");
		return ptr;
	}
