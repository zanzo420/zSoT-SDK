...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_TunnelOfTheDamnedPortalLocator_WLD.BP_TunnelOfTheDamnedPortalLocator_WLD_C.UserConstructionScript");
