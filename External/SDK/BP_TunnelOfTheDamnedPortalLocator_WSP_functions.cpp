...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_TunnelOfTheDamnedPortalLocator_WSP.BP_TunnelOfTheDamnedPortalLocator_WSP_C.UserConstructionScript");
