...
{
public:
	unsigned char                                      UnknownData_L8EW[0x8];                                     // 0x05E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ATY2[0x1C];                                    // 0x05FC(0x001C) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_83N0[0x8];                                     // 0x0618(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_9259[0x50];                                    // 0x0630(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_9R3U[0xC];                                     // 0x0634(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_34QF[0x70];                                    // 0x00C8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TZPH[0x5];                                     // 0x014B(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_I2UR[0xF8];                                    // 0x03D0(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SOH5[0x8];                                     // 0x0500(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GZVY[0x3];                                     // 0x050D(0x0003) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EKBM[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N5WF[0x48];                                    // 0x00D8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R7ZI[0x2];                                     // 0x0126(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1JX4[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)
