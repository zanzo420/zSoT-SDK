...
{
public:
	unsigned char                                      UnknownData_GXDN[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LOKA[0x6];                                     // 0x02D2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NYUX[0xC0];                                    // 0x0300(0x00C0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_C3J0[0x20];                                    // 0x05A0(0x0020) MISSED OFFSET (PADDING)
