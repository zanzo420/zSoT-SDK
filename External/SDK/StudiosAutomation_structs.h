...
struct FFolderTotals
{
	...
	unsigned char                                      UnknownData_HXFO[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAssetAuditConstantEntry
{
	...
	unsigned char                                      UnknownData_FXTU[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FCollectionLimits
{
	...
	unsigned char                                      UnknownData_1U78[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M5T9[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (PADDING)
