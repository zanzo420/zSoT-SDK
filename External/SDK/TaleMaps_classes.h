...
{
public:
	unsigned char                                      UnknownData_49S7[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_POA5[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LF8K[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_TBK0[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VM3B[0x48];                                    // 0x0068(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QMSO[0x40];                                    // 0x0068(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Y5V5[0x30];                                    // 0x0068(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_4IMT[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (PADDING)
