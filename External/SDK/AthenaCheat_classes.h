...
public:
	...
	unsigned char                                      UnknownData_2P23[0x28];                                    // 0x0088(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GGLF[0x3C];                                    // 0x00D4(0x003C) MISSED OFFSET (PADDING)
