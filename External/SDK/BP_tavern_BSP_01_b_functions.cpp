...
void ABP_tavern_BSP_01_b_C::AfterRead()
{
	...
	READ_PTR_FULL(NavMeshBlocker7, UBoxComponent);
	READ_PTR_FULL(NavMeshBlocker6, UBoxComponent);
	READ_PTR_FULL(NavMesh_Blocker5, UBoxComponent);
	READ_PTR_FULL(NavMesh_Blocker4, UBoxComponent);
	READ_PTR_FULL(NavMesh_Blocker3, UBoxComponent);
	READ_PTR_FULL(NavMesh_Blocker2, UBoxComponent);
	READ_PTR_FULL(NavMesh_Blocker, UBoxComponent);
	READ_PTR_FULL(StaticMesh3, UStaticMeshComponent);
	READ_PTR_FULL(Roof_collison, UBoxComponent);
	...
	READ_PTR_FULL(BP_OutpostCrate_cmn_wooden_crate_01_a, UChildActorComponent);
	READ_PTR_FULL(BP_IslandStorageBarrel_Outpost_12, UChildActorComponent);
	READ_PTR_FULL(BP_IslandStorageBarrel_Outpost_11, UChildActorComponent);
	READ_PTR_FULL(BP_IslandStorageBarrel_Outpost_10, UChildActorComponent);
	READ_PTR_FULL(BP_IslandStorageBarrel_Outpost_9, UChildActorComponent);
	READ_PTR_FULL(BP_IslandStorageBarrel_Outpost_8, UChildActorComponent);
	READ_PTR_FULL(BP_IslandStorageBarrel_Outpost_7, UChildActorComponent);
	READ_PTR_FULL(BP_IslandStorageBarrel_Outpost_6, UChildActorComponent);
	...
	READ_PTR_FULL(StaticMesh58, UStaticMeshComponent);
	READ_PTR_FULL(shp_int_hook_01_a, UStaticMeshComponent);
	READ_PTR_FULL(shp_fry_pan_01_a1, UStaticMeshComponent);
	READ_PTR_FULL(cmn_animal_cage_01_a, UStaticMeshComponent);
	READ_PTR_FULL(cmn_pirate_grave_01_c, UStaticMeshComponent);
	READ_PTR_FULL(cmn_pirate_grave_01_a, UStaticMeshComponent);
	...
	READ_PTR_FULL(bp_lantern_hook_01_a2, UChildActorComponent);
	...
	READ_PTR_FULL(bld_tvn_entrance_boat_01_a, UStaticMeshComponent);
...
void ABP_tavern_BSP_01_b_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(tls_lantern_01_e);
	DELE_PTR_FULL(SpotLight8);
	DELE_PTR_FULL(NavMeshBlocker8);
	DELE_PTR_FULL(SpotLight7);
	DELE_PTR_FULL(PetHangoutSpot);
	DELE_PTR_FULL(RainBlockerUnderground);
	DELE_PTR_FULL(NavMeshBlocker7);
	DELE_PTR_FULL(NavMeshBlocker6);
	DELE_PTR_FULL(NavMesh_Blocker5);
	DELE_PTR_FULL(NavMesh_Blocker4);
	DELE_PTR_FULL(NavMesh_Blocker3);
	DELE_PTR_FULL(NavMesh_Blocker2);
	DELE_PTR_FULL(NavMesh_Blocker);
	DELE_PTR_FULL(StaticMesh3);
	DELE_PTR_FULL(Roof_collison);
	...
	DELE_PTR_FULL(BP_OutpostCrate_cmn_wooden_crate_01_a);
	DELE_PTR_FULL(BP_IslandStorageBarrel_Outpost_12);
	DELE_PTR_FULL(BP_IslandStorageBarrel_Outpost_11);
	DELE_PTR_FULL(BP_IslandStorageBarrel_Outpost_10);
	DELE_PTR_FULL(BP_IslandStorageBarrel_Outpost_9);
	DELE_PTR_FULL(BP_IslandStorageBarrel_Outpost_8);
	DELE_PTR_FULL(BP_IslandStorageBarrel_Outpost_7);
	DELE_PTR_FULL(BP_IslandStorageBarrel_Outpost_6);
	...
	DELE_PTR_FULL(StaticMesh58);
	DELE_PTR_FULL(shp_int_hook_01_a);
	DELE_PTR_FULL(shp_fry_pan_01_a1);
	DELE_PTR_FULL(cmn_animal_cage_01_a);
	DELE_PTR_FULL(cmn_pirate_grave_01_c);
	DELE_PTR_FULL(cmn_pirate_grave_01_a);
	...
	DELE_PTR_FULL(bp_lantern_hook_01_a2);
	...
	DELE_PTR_FULL(bld_tvn_entrance_boat_01_a);
