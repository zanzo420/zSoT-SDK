...
{
	unsigned char                                      UnknownData_HGFF[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DH7N[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3N6Z[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9XYX[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G2PA[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_U7OE[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8MOT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FServerMigrationHeartbeatEvent
{
	...
	unsigned char                                      UnknownData_DZIQ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WLQI[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
