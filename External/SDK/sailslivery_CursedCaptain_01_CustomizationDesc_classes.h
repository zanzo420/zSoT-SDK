...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass sailslivery_CursedCaptain_01_CustomizationDesc.sailslivery_CursedCaptain_01_CustomizationDesc_C");
		return ptr;
	}
