...
public:
	...
	unsigned char                                      UnknownData_GAG6[0xAC];                                    // 0x0594(0x00AC) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LJSL[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MI3V[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5W9U[0x88];                                    // 0x0498(0x0088) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8546[0x8];                                     // 0x02E8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ODC8[0x8];                                     // 0x0618(0x0008) Fix Super Size
