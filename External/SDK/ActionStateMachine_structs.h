...
{
	unsigned char                                      UnknownData_P444[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1CM8[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FResetStateMachineRpc
{
	...
	unsigned char                                      UnknownData_FYO4[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_WP8C[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X8LY[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FTestActionStateSerialisableData : public FActionStateSerialisableData
{
	...
	unsigned char                                      UnknownData_8XY5[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FActionStatePriorityRelationship
{
	...
	unsigned char                                      UnknownData_K1UN[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UWLC[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
struct FActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_8IBZ[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FInnerTestStruct
{
	...
	unsigned char                                      UnknownData_HYHE[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTestActionStateConstructionInfo : public FActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_GMQF[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FTestActionStateConstructionInfoWithInner : public FActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_1RW4[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_Z9J9[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6NIT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EP7D[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8UGJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FTestActionStateMessage : public FActionStateMessage
{
	...
	unsigned char                                      UnknownData_NTQR[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FTestActorActionStateConstructionInfo : public FActorActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_REIU[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
