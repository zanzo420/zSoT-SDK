...
{
public:
	unsigned char                                      UnknownData_YUVF[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A7H7[0xB8];                                    // 0x0110(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7G3K[0x20];                                    // 0x00D8(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0C1I[0x30];                                    // 0x03D0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CWA4[0x118];                                   // 0x0408(0x0118) MISSED OFFSET (PADDING)
