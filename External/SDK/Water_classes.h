...
{
public:
	unsigned char                                      UnknownData_LCZ2[0x28];                                    // 0x0418(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JV7Y[0x8];                                     // 0x03D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PXCJ[0x10];                                    // 0x03D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RC6Y[0x50];                                    // 0x03F8(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_ATWY[0x8];                                     // 0x0588(0x0008) Fix Super Size
	unsigned char                                      UnknownData_RBNT[0x10];                                    // 0x0590(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Y35R[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5RGJ[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_8OS7[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q4IC[0x8];                                     // 0x05A8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_Y6A0[0x20];                                    // 0x05B0(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MRNR[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SCLK[0x7];                                     // 0x0109(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5PIK[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GI3L[0x18];                                    // 0x0140(0x0018) MISSED OFFSET (PADDING)
