...
{
public:
	unsigned char                                      UnknownData_OGYK[0x8];                                     // 0x03D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K5MU[0x2];                                     // 0x03E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z4IS[0x2];                                     // 0x03FA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R6UP[0x4];                                     // 0x0404(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UN7X[0x3C];                                    // 0x045C(0x003C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MBHU[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
