...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TheSunkenCrystal_DriveDownFloatingDebris_04.BP_TheSunkenCrystal_DriveDownFloatingDebris_04_C");
		return ptr;
	}
