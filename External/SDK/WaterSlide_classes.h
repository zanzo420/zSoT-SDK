...
public:
	...
	unsigned char                                      UnknownData_0L6P[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DNX3[0x3];                                     // 0x0409(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8NNZ[0x20];                                    // 0x0420(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YZBX[0x10];                                    // 0x0230(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7KLH[0x8];                                     // 0x00E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_842A[0x14];                                    // 0x00FC(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
