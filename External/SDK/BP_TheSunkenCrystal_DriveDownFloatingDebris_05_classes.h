...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TheSunkenCrystal_DriveDownFloatingDebris_05.BP_TheSunkenCrystal_DriveDownFloatingDebris_05_C");
		return ptr;
	}
