...
{
public:
	unsigned char                                      UnknownData_1M4P[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_M8EK[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_939T[0x20];                                    // 0x0050(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_PZTO[0x50];                                    // 0x0038(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TZI9[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FWwiseNativeEmitterPoolDensityParams        PoolDensityParams;                                         // 0x0040(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData_90IF[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5RZ7[0x13];                                    // 0x02CD(0x0013) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JBIY[0xB0];                                    // 0x0028(0x00B0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CZ0I[0x8];                                     // 0x05E8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FKLT[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_N7J9[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_02C7[0x4];                                     // 0x02BC(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_APKH[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WK4Q[0xA8];                                    // 0x0048(0x00A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T6IC[0x38];                                    // 0x00F8(0x0038) MISSED OFFSET (PADDING)
