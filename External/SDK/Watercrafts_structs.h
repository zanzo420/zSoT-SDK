...
struct FScrapeableDamageSpeedEntry
{
	...
	unsigned char                                      UnknownData_KXRQ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FWatercraftRolloverCorrector
{
	...
	unsigned char                                      UnknownData_VJ2B[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FRowboatDamageEffectData
{
	...
	unsigned char                                      UnknownData_XQ44[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (PADDING)
...
struct FOar
{
	...
	unsigned char                                      UnknownData_VYBR[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0XN9[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3XZO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_73NX[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRowboatMountStateTelemetryEvent
{
	...
	unsigned char                                      UnknownData_KIVB[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FWatercraftDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_5UKG[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
