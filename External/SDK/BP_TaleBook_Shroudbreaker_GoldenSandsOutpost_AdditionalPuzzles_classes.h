...
// BlueprintGeneratedClass BP_TaleBook_Shroudbreaker_GoldenSandsOutpost_AdditionalPuzzles.BP_TaleBook_Shroudbreaker_GoldenSandsOutpost_AdditionalPuzzles_C
// 0x0030 (FullSize[0x0728] - InheritedSize[0x06F8])
class ABP_TaleBook_Shroudbreaker_GoldenSandsOutpost_AdditionalPuzzles_C : public AVoyageProposalContainer
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TaleBook_Shroudbreaker_GoldenSandsOutpost_AdditionalPuzzles.BP_TaleBook_Shroudbreaker_GoldenSandsOutpost_AdditionalPuzzles_C");
		return ptr;
	}
