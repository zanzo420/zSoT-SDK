...
struct FCoordinatedKrakenSpecialEvent
{
	...
	unsigned char                                      UnknownData_CM01[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              TimeOffset;                                                // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_ERBK[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenTentacleAction
{
	...
	unsigned char                                      UnknownData_LR0Q[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenHeadAction
{
	...
	unsigned char                                      UnknownData_VJ58[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenExplosionEvent
{
	...
	float                                              TimeOffset;                                                // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_6E2V[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenAction
{
	...
	unsigned char                                      UnknownData_44VU[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleAnimationStateParams
{
	...
	unsigned char                                      UnknownData_S698[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleAnimationState
{
	...
	unsigned char                                      UnknownData_CJLH[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleVFXParams
{
	...
	unsigned char                                      UnknownData_PKVJ[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingTentacleParams
{
	...
	unsigned char                                      UnknownData_T7IO[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenWeightedBehaviour
{
	...
	unsigned char                                      UnknownData_6PW2[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FKrakenBehaviourParams
{
	...
	unsigned char                                      UnknownData_TRW7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentaclesChanceParams
{
	...
	unsigned char                                      UnknownData_UEQ3[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleParams
{
	...
	unsigned char                                      UnknownData_91GX[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenParams
{
	...
	unsigned char                                      UnknownData_W3YJ[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8ZJ6[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenAnimatedTentacleTransitionAnimation
{
	...
	unsigned char                                      UnknownData_GMJD[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenAnimatedTentacleStateAnimationMapping
{
	...
	unsigned char                                      UnknownData_N4E8[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenHeadStateAnimationMapping
{
	...
	class UAnimSequence*                               Animation;                                                 // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               Loop;                                                      // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_VGAU[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenHeadHitReactAnimations
{
	...
	unsigned char                                      UnknownData_ZJU0[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleBehaviourActionChances
{
	...
	unsigned char                                      UnknownData_ANWR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleBehaviourParams
{
	...
	unsigned char                                      UnknownData_WE3P[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E05Z[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenPlayerGrabbingHoldingStateTransitionChance
{
	...
	unsigned char                                      UnknownData_0BSM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenPlayerGrabbingBehaviourParams : public FKrakenTentacleBehaviourParams
{
	...
	unsigned char                                      UnknownData_GJ28[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenServiceSpawnParams
{
	...
	unsigned char                                      UnknownData_M7RU[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	int                                                Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_3YGF[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3F63[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FWeightedProbabilityRangeOfRanges           NumZonesToDamage;                                          // 0x0068(0x0030) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_BNO5[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (PADDING)
...
struct FKrakenShipHittingBehaviourParams
{
	...
	unsigned char                                      UnknownData_97H8[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenDynamicsStateEvent
{
	...
	unsigned char                                      UnknownData_5RNR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourHealthParams
{
	...
	unsigned char                                      UnknownData_XYG8[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingBehaviourNamedTransform
{
	...
	unsigned char                                      UnknownData_11YJ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWarningParams
{
	...
	unsigned char                                      UnknownData_TM45[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GX3E[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenDynamicsStateFragmentParams
{
	...
	unsigned char                                      UnknownData_GZTD[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapLocationParams
{
	...
	unsigned char                                      UnknownData_CKVD[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	float                                              Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_09Z6[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapParams
{
	...
	unsigned char                                      UnknownData_F62N[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HMS4[0xC];                                     // 0x0054(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourHeavyAttackParams
{
	...
	unsigned char                                      UnknownData_RZCM[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingBehaviourDamageParams
{
	...
	unsigned char                                      UnknownData_OPM5[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	class UClass*                                      ShipSize;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_M2IE[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCoordinatedKrakenPhaseAssetEntry
{
	...
	unsigned char                                      UnknownData_VJY7[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y1IC[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3XZB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HZDV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LQNJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EUFK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KOR8[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XLRM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SMLY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OZA1[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AAPJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_R3XA[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0NDN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9PT0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_F15Y[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventKrakenAnimatedTentacleAnimationStarted
{
	...
	unsigned char                                      UnknownData_C40J[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2TW0[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QXV5[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4GDZ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FKrakenDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_QZGZ[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
