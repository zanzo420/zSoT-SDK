...
{
	static auto fn = UObject::FindObject<UFunction>("Function Damagers.ShipDamagerComponent.EndDamage");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Damagers.ShipDamagerComponent.BeginDamage");
