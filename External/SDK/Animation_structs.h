...
struct FLimbIK
{
	unsigned char                                      UnknownData_ZLPV[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FCharacterAnimationIKUpdateParams
{
	...
	unsigned char                                      UnknownData_LMW5[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O2LF[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       ParentBone;                                                // 0x0034(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_89N2[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5RAW[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_U9FK[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationDataStoreAssetWeakReferenceEntry
{
	...
	unsigned char                                      UnknownData_QP9J[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FDockableInfo
{
	...
	unsigned char                                      UnknownData_LZ3V[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FDocker
{
	unsigned char                                      UnknownData_K15S[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FActorVelocityData
{
	...
	unsigned char                                      UnknownData_ERBC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTransformBlendCurve
{
	...
	unsigned char                                      UnknownData_KUJO[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IM8K[0x7];                                     // 0x0179(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7RM9[0x7];                                     // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRuntimeVectorCurve                         ScaleCurve;                                                // 0x02F8(0x0170) (Edit)
	unsigned char                                      UnknownData_8KV0[0x8];                                     // 0x0468(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HHH3[0x30];                                    // 0x04D0(0x0030) MISSED OFFSET (PADDING)
...
struct FWeightedAnimationData
{
	...
	unsigned char                                      UnknownData_V8CP[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NDDJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3D4R[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_54IV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventHitReactAnimationRequested
{
	...
	unsigned char                                      UnknownData_WE3Q[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FHitReactionAnimationState
{
	...
	unsigned char                                      UnknownData_4JUR[0x1E];                                    // 0x000A(0x001E) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H8VN[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SXQ5[0x77];                                    // 0x0021(0x0077) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FWM6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimNode_WeightedLoadOnDemandSquencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_Q21L[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NHD5[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J2MK[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J6T6[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0D76[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FCustomAnimationMontageStateMachine
{
	...
	unsigned char                                      UnknownData_PY91[0xC0];                                    // 0x0018(0x00C0) MISSED OFFSET (PADDING)
