...
// BlueprintGeneratedClass BP_GlitterbeardLoreBook_ItNeverRains.BP_GlitterbeardLoreBook_ItNeverRains_C
// 0x0018 (FullSize[0x04B0] - InheritedSize[0x0498])
class ABP_GlitterbeardLoreBook_ItNeverRains_C : public AModalInteractionProxy
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_GlitterbeardLoreBook_ItNeverRains.BP_GlitterbeardLoreBook_ItNeverRains_C");
		return ptr;
	}
