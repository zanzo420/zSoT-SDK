...
{
public:
	unsigned char                                      UnknownData_48NF[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IMG5[0xB0];                                    // 0x0028(0x00B0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8M14[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_N0TQ[0x58];                                    // 0x0030(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LZTR[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZJDG[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4G29[0x8];                                     // 0x05C8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_G4IN[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
