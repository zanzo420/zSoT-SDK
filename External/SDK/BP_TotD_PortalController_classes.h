...
public:
	...
	unsigned char                                      UnknownData_F5WY[0x3];                                     // 0x03FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TotD_PortalController.BP_TotD_PortalController_C");
		return ptr;
	}
