...
{
public:
	unsigned char                                      UnknownData_7FAZ[0x18];                                    // 0x03D0(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JHWY[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K3VB[0x768];                                   // 0x00F0(0x0768) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8O98[0x18];                                    // 0x0858(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2DBS[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6854[0x10];                                    // 0x03D8(0x0010) MISSED OFFSET (PADDING)
