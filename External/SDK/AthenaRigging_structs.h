...
struct FRopeCatenaryDynamicsParams
{
	...
	unsigned char                                      UnknownData_PMO3[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FRopeStyleParams
{
	...
	unsigned char                                      UnknownData_ASS3[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FRiggingSystemPulleyParams
{
	...
	unsigned char                                      UnknownData_BHDB[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OCJ7[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FRiggingSystemLineParams
{
	...
	unsigned char                                      UnknownData_QAG1[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)
