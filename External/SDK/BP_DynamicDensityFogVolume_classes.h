...
public:
	...
	unsigned char                                      UnknownData_GRZC[0x3];                                     // 0x03ED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W1RJ[0x7];                                     // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FBP_Struct_DynamicFogVolumeParams>   StateParams;                                               // 0x0430(0x0010) (Edit, BlueprintVisible, ZeroConstructor)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_DynamicDensityFogVolume.BP_DynamicDensityFogVolume_C");
		return ptr;
	}
