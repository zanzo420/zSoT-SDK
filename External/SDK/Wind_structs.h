...
struct FWindZoneParams
{
	...
	unsigned char                                      UnknownData_39XP[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7V3L[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3PE7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
