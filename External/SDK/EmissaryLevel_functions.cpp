...
void FEmissaryVotePassedEvent::AfterRead()
{
}

void FEmissaryVotePassedEvent::BeforeDelete()
{
}

void FEmissaryVotesChangedEvent::AfterRead()
{
}

void FEmissaryVotesChangedEvent::BeforeDelete()
{
}
...
void AEmissaryVotingService::AfterRead()
{
	AActor::AfterRead();
...
void AEmissaryVotingService::BeforeDelete()
{
	AActor::BeforeDelete();
